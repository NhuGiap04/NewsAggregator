...
public class EmbedderService {
    ...
    public Mono<List<Double>> createEmbeddingAPI(String text) {
    ...
    public static void main(String[] args) {
        ...
        embedderService.LOCAL_EMBEDDER_URL = "http://localhost:9999/embedding-post";

        embedderService.init();
        Mono<List<Double>> embeddings = embedderService.createEmbeddingAPI("An apple a day keeps the doctor away.");
